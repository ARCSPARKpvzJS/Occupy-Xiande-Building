...
public class GameFrame extends Frame implements KeyListener {
    ...
    Player player2;//玩家1
    Map map;
    Vector<TuXiang> fun = new Vector<TuXiang>();//储存滑稽的容器;
    ...
    public GameFrame() throws HeadlessException {
        ...
        player2 = new Player(1300, Constant.GAME_HEIGHT - 96, 5, 96, 80, map.getBarriers(), 2);
    ...
    public void paint(Graphics g) {
        ...
        if (!isStart && !isEnd) {
            ...
            if (System.currentTimeMillis() % 10 == 0) {
                TuXiang e = new TuXiang(1, 700, 0, 0, 0);
                fun.add(e);
            }
            //画开始/暂停背景
            g.drawImage(backPng, 0, 0, Constant.GAME_WIDTH, Constant.GAME_HEIGHT, null);//绘制背景图
